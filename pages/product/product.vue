	...
	<view class="container">
		...
		<view class="introduce-section">
			...
			<view class="price-box">
				<text class="price-tip">{{ goodsInfo.type==0?"租用价格":"场地价格" }} ¥</text>
		...
		<view class="detail-desc">
			...
			<view class="" style="">
				<view class="u-flex u-row-center u-p-20" style="width: 100vw">{{goodsInfo.content}}</view>
		...
		<!-- 底部操作菜单 -->
		<!-- <view class="page-bottom" v-if="type==0">
			<navigator @click="back" open-type="switchTab" class="p-b-btn">
			...
			<view class="action-btn-group">
				<button type="primary" class=" action-btn no-border buy-now-btn" @click="buy">立即使用</button>
			</view>
		</view>
		 -->
	...
	export default{
		...
		methods:{
			...
			getData(){
				...
				appRequest.request({
					method: "POST",
					url: appRequest.urlMap.findPhClothPlace,
					data:{
						id:_this.id
					},
