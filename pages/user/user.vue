    ...
    <view class="container">  
		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image style="background-color: white;" class="portrait" :src="user.pic"></image>
				</view>
				<view class="info-box">
		...
		<view class="u-flex u-direction-row u-row-center" v-if="!user">
			<view class="container">
				<view class="list-cell " style="text-align: center;">
					<text class="cell-tit" style="color: #909399;">游客无法享受摄影的快乐</text>
				</view>
		...
		>
			...
			<view class="order-section"  >
				<view class="order-item" @click="navTo('/pages/order/createOrder?index=0')"  hover-class="common-hover" :hover-stay-time="50">
					<text class="yticon icon-daifukuan"></text>
					<text>未完成</text>
				</view>
				<view class="order-item" @click="navTo('/pages/order/createOrder?index=1')" hover-class="common-hover"  :hover-stay-time="50">
					<text class="yticon icon-yishouhuo"></text>
					<text>已完成</text>
				</view>
			</view>
			<!-- 浏览历史 -->
			<view class="history-section icon" v-if="user">
				<view class="sec-header">
					<text>其他功能</text>
				</view>
				<!-- <list-cell icon="icon-tuandui" iconColor="#3f80de" title="个人信息" border="" @eventClick="navTo('/pages/userinfo/userinfo')"></list-cell>
				
				<list-cell icon="icon-shezhi1" iconColor="#3f80de" title="设置" border="" @eventClick="navTo('/pages/set/set')"></list-cell> -->
